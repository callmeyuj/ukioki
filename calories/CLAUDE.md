...
| **../harness.md**（品牌级） | 行为守则 | 改代码时遵守什么规矩？ |

> 迭代规范统一在根目录 `../harness.md`（2026/09/08 起模块内不再单独维护 harness.md）
...
- `CHANGELOG.md` — 模块版本记录（迭代行为规范见根目录 `../harness.md`）
